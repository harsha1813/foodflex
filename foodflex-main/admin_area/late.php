...
<body>
    <div class="table-container">
        <table>
            <thead>
                <tr align="center">
                    <td colspan="6"><h2>View Late Orders</h2></td>
                </tr>
                <tr align="center">
                    <th>S.N</th>
                    <th>Food Item</th>
            ...
            <tbody>
                ...
                $get_order = "SELECT * FROM late ORDER BY order_id DESC"; // Order by order_id or another valid column
                ...
                while ($row_order = mysqli_fetch_assoc($run_order)) {
                    ...
                    // Assuming 'order_time' is now a valid column in your late table
                    ...
                    <tr align="center">
                        ...
                        <td class="action-links">
                            <a href="late.php?delete_completed_order='.$order_id.'" class="delete-link">Delete</a>
                        </td> <!-- Delete link -->
                    </tr>';
                }
                ?>
    ...
    if (isset($_GET['delete_completed_order'])) {
        ...
        $delete_order = "DELETE FROM late WHERE order_id = '$delete_id'";
        $run_delete = mysqli_query($con, $delete_order);

        if ($run_delete) {
             echo "<script>alert('Order Deleted from Records!'); window.location.href = 'index.php?view_late';</script>";
        }
    }
    ?>
</body>
